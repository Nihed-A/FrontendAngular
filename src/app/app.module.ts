...
import {RequestClaimAddComponent} from "./main/request-claim/request-claim-add/request-claim-add.component";
...
const appRoutes: Routes = [
  ...
  },
  {
    ...
    {
     path: 'request-claim',
     loadChildren: () => import('./main/request-claim/request-claim.module').then(m => m.RequestClaimModule)
    },
    {
        path: 'chat',
